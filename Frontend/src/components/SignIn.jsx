  ...
  return (
    <div> 
      <div className='flex justify-center'>
          <h1 className='inline-block  mt-20 mb-20 text-4xl font-bold text-white rounded-br-xl rounded-tl-xl rounded-bl-xl bg-blue-500 p-5 ' >MediInsight</h1>
      </div>
